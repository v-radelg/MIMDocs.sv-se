...
## [Metodtips](mim-best-practices.md)
...
## [Distribuera i miljöer i TLS 1.2- eller FIPS-läge](preparing-tls.md)
## [Första distributionen](microsoft-identity-manager-deploy.md)
### [Domänkonfiguration](preparing-domain.md)
### [Domänkonfiguration för GMSA](preparing-domain-gmsa.md)
...
## [Uppgradera till MIM 2016 SP2](microsoft-identity-manager-2016-service-pack-2-upgrade-path.md)
...
## [Konfigurera Graph-anslutningstjänsten för B2B](microsoft-identity-manager-2016-graph-b2b-scenario.md)
## [Använda Azure MFA Server i PAM eller SSPR](working-with-mfaserver-for-mim.md)
## [Använda en anpassad MFA-provider i PAM eller SSPR](working-with-custommfaserver-for-mim.md)
...
## [Best Practices Analyzer](https://technet.microsoft.com/library/jj203402)
...
### [Allmän SQL – steg för steg](./reference/microsoft-identity-manager-2016-connector-genericsql-step-by-step.md)
