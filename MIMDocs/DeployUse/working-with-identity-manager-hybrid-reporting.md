...
# Arbeta med Identity Manager Hybrid Reporting - öppen förhandsversion (uppdatera)
...
## Installera Microsoft Identity Manager Reporting Agent i Azure AD
...
## Visa hybridrapporter i Azure Portal
