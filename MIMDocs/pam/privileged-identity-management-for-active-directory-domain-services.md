---
title: "Privileged Access Management för Active Directory Domain Services | Microsoft Identity Manager"
description: 
keywords: 
author: kgremban
manager: femila
...
Privileged Access Management (PAM) är en lösning som är baserad på Microsoft Identity Manager (MIM), Windows Server 2012 R2 och Windows Server Technical Preview. Med den kan organisationer begränsa privilegierad åtkomst i befintliga Active Directory-miljöer.
