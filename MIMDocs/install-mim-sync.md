...
7. Konfigurera synkroniseringstjänstkontot enligt de konton du tidigare skapat:
   ...
   2. Ords<em>Pass@word1</em>

   3. Tjänstkontodomän eller namnet på den lokala datorn: *contoso*

    >[!NOTE]
    >MIM 2016 SP2 och senare: för grupphanterade tjänst konton ser du **$** till att tecknen är i slutet av tjänst konto namnet, t. ex. MIMSync $, och lämnar fältet lösen ord tomt.
